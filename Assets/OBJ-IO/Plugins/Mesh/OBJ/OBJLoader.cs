...
public class OBJLoader
{
    ...
    private static readonly Dictionary<string, Action<string>> m_ParseOBJActionDictionary = new Dictionary<string, Action<string>>
    {
        ...
        { "v", (lEntry) => { m_OBJData.m_Vertices.Add(UnityExtension.Utils.ParseVector3String(lEntry)); } },
        { "vn", (lEntry) => { m_OBJData.m_Normals.Add(UnityExtension.Utils.ParseVector3String(lEntry)); } },
        { "vt", (lEntry) => { m_OBJData.m_UVs.Add(UnityExtension.Utils.ParseVector2String(lEntry)); } },
        { "vt2", (lEntry) => { m_OBJData.m_UV2s.Add(UnityExtension.Utils.ParseVector2String(lEntry)); } },
        { "vc", (lEntry) => { m_OBJData.m_Colors.Add(UnityExtension.Utils.ParseVector4String(lEntry).ToColor()); } },
		{ "f", PushOBJFace },
        { "g", PushOBJGroup },
    };
    ...
    private static readonly Dictionary<string, Action<string>> m_ParseMTLActionDictionary = new Dictionary<string, Action<string>>
    {
        ...
        { "Ka", (lEntry) => { m_CurrentMaterial.m_AmbientColor = UnityExtension.Utils.ParseVector3String(lEntry).ToColor(); } },
        { "Kd", (lEntry) => { m_CurrentMaterial.m_DiffuseColor = UnityExtension.Utils.ParseVector3String(lEntry).ToColor(); } },
        { "Ks", (lEntry) => { m_CurrentMaterial.m_SpecularColor = UnityExtension.Utils.ParseVector3String(lEntry).ToColor(); } },
